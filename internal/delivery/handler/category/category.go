...
func (categoryHandler *CategoryHandlerImpl) CreateCategory(ctx *fiber.Ctx) error {
	...
	return handler.SuccessResponse(ctx, fiber.StatusCreated, "success create category", map[string]any{
		"categories": result,
	})
...
func (categoryHandler *CategoryHandlerImpl) GetAllCategory(ctx *fiber.Ctx) error {
	...
	return handler.SuccessResponse(ctx, fiber.StatusOK, "success get category", map[string]any{
		"categories": result,
	})
...
func (categoryHandler *CategoryHandlerImpl) UpdateCategoryById(ctx *fiber.Ctx) error {
	...
	return handler.SuccessResponse(ctx, fiber.StatusOK, "success update category", map[string]any{
		"categories": result,
	})
}
