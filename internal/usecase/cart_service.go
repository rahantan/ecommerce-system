...
func NewCartItemService(cartrepo domain.CartItemRepositories, productService domain.ProductServices, db *gorm.DB) domain.CartItemServices {
...
func (cartService *CartItemServiceImpl) loadRes(cartItem *model.CartItemModel) *response.ResCartItem {
